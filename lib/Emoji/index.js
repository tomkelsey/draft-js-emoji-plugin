...
var Emoji = function Emoji(_ref) {
  ...
  var shortName = (0, _emojione.toShort)(decoratedText);
  // short name to image url code steal from emojione source code
  var shortNameForImage = _emojione.emojioneList[shortName].unicode[_emojione.emojioneList[shortName].unicode.length - 1];
  ...
  return _react2.default.createElement(
    'span',
    {
      ...
      title: (0, _emojione.toShort)(decoratedText),
